...
export default function PromptLibraryHomePage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 select-none font-sans">
      {/* HERO BANNER */}
      <div className="relative overflow-hidden rounded-[32px] bg-white p-8 sm:p-12 border border-[#E8E3FF] text-[#1E1B2E] shadow-soft">
        {/* Soft Ambient Radial Lights */}
        <div className="pointer-events-none absolute -top-24 -right-24 w-96 h-96 rounded-full bg-[#8B7FE8]/15 blur-[100px]" />
        <div className="pointer-events-none absolute -bottom-24 -left-24 w-96 h-96 rounded-full bg-[#FFC9DE]/30 blur-[100px]" />

        <div className="relative z-10 max-w-2xl space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#F5F2FF] border border-[#E8E3FF] text-xs font-extrabold text-[#8B7FE8]">
            <Sparkles className="w-4 h-4 text-[#8B7FE8]" />
            <span>Curated Prompt Ecosystem</span>
          </div>

          <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-[#1E1B2E]">
            Explore Curated <span className="bg-gradient-to-r from-[#8B7FE8] to-[#7062E0] bg-clip-text text-transparent">AI Prompts</span>
          </h1>
