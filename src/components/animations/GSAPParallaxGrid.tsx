...
export default function GSAPParallaxGrid() {
  ...
  return (
    ...
    >
      ...
      {/* Grid of Parallax Floating Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {features.map((item, idx) => {
          ...
          return (
            <div
              key={idx}
              className="parallax-card bg-white rounded-3xl p-8 border border-[#EAE6FE] shadow-soft-sm hover:shadow-soft-md transition-all duration-300 flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-6">
                  <div
                    className="w-13 h-13 rounded-2xl flex items-center justify-center font-bold text-xl shadow-soft-sm"
              ...
              <div className="pt-6 mt-6 border-t border-[#EAE6FE]/70 flex items-center justify-between text-xs font-semibold text-[#8B7FE8]">
