    ...
    <div className="relative w-full max-w-md mx-auto">
      ...
      <div className="relative glass-card rounded-3xl p-6 sm:p-8 shadow-2xl border border-[#EAE6FE] bg-white/95 backdrop-blur-xl transition-all duration-300">
        ...
        {(mode === "login" || mode === "signup") && (
          <>
            <div className="flex p-1 bg-[#F3F0FE] rounded-2xl mb-5 border border-[#EAE6FE]/80">
              <button
                type="button"
            ...
            <div className="space-y-4 mb-6">
              <Button
                ...
                className="w-full py-5 px-4 rounded-2xl bg-white border border-[#EAE6FE] hover:bg-[#F3F0FE] text-sm font-semibold text-[#1E1B2E] shadow-sm flex items-center justify-center gap-2.5 transition-all cursor-pointer"
              >
              ...
              <div className="relative flex items-center justify-center">
                <div className="border-t border-[#EAE6FE] w-full" />
                <span className="bg-white px-3 text-[10px] font-bold text-[#6B6785] uppercase tracking-wider absolute">
